...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default=str(PROJECT_ROOT / 'content_data'),
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default=str(PROJECT_ROOT / 'style_data'),
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default=str(PROJECT_ROOT / 'vgg_normalised.pth'),
...
def main():
    ...
    save_dir = PROJECT_ROOT / 'experiment' / args.experiment
